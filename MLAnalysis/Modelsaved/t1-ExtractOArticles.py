...
for line in listpmcidfile.readlines():
    listpmcid.append(line.split("\n")[0])
listpmcidfile.close()
print(str(len(listpmcid))+" PMCIDs Checked.")
...
print ("There is "+str(int(nbArticlesScan-nonOA))+" documents that are OA and contains accession numbers.")
