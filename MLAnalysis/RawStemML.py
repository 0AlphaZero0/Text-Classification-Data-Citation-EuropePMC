...
X_train_dtm = stem_vectorizer.fit_transform(X_train[[Citation_str]].fillna('').values.reshape(-1)).todense()
X_test_dtm = stem_vectorizer.transform(X_test[[Citation_str]].fillna('').values.reshape(-1)).todense()
