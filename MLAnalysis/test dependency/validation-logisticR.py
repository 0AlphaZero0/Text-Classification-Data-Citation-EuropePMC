...
result_outfile="ResultLogisticR1TEST.csv"
# Parameters
k_cross_val=5
average="macro"
gamma="auto"
...
data=read_csv(
	...
	sep=",")
#
data[completeCitation]=data[[PreCitation_str,Citation_str,PostCitation_str,"Dependencies"]].apply(lambda x : '{}{}'.format(x[0],x[1]),axis=1)
#
