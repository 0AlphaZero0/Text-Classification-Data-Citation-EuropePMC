...
result_outfile="tuneResultMLparam.csv"
# Parameters
k_cross_val=4
average="macro"
gamma="auto"
...
tuned_parameters=[{
	...
	'max_iter':[
		...
		10000]}]
#
clfSVM=GridSearchCV(LogisticRegression(solver='lbfgs',multi_class='multinomial',class_weight=class_weight),tuned_parameters,cv=k_cross_val)
#
################################################    Functions     #################################################
#
def lemma_word(word):
